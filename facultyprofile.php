                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="profile-img">
                                <img src="<?php echo 'dbimg/faculty/' . $user_image; ?>" width="100px" height="100px" class="img-circle img-responsive" alt="">
                        ...
                        <div class="col-md-2"><a href="stuupdateprofile.php">
                                <input type="submit" class="profile-edit-btn" name="facultyupdateprofile" value="Edit Profile" />
                        </div>

                        <?php
                        if (isset($_POST['facultyupdateprofile'])) {
                            echo "<script>window.open('facultyupdprofile.php','_self')</script>";
                        }
                        ?>
