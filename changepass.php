				...
				<div class="d-flex justify-content-center form_container">
					<form>
						<div class="input-group mb-3">
							...
							<input type="text" name="" class="form-control input_user" value="" placeholder="Old password ">
						</div>
                        ...
                        <div class="input-group mb-2">
							...
							<input type="password" name="" class="form-control input_pass" value="" placeholder="Re enter new Password">
						</div>
				 	...
				 	<button type="button" name="button" class="btn login_btn" value="change Pasword ">Login</button>
				   </div>
					</form>
				</div>
